...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=32&duration=3000&pause=800&color=6C63FF&center=true&vCenter=true&multiline=true&width=800&height=100&lines=Hey+there!+I'm+Aayush+Paradkar+👋;Java+Developer+%7C+Spring+Boot+%7C+Microservices;Building+Scalable+Backend+Systems+🚀)](https://git.io/typing-svg)
...
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:aayushpawar07@gmail.com)
...
public class AayushParadkar {
    ...
    String role        = "💻 Java Developer @ Cloud Nexus";
    ...
    Map<String, String[]> skills = Map.of(
        ...
        "devOps",    new String[]{"Docker", "AWS EC2", "Git", "Linux"},
        "frontend",  new String[]{"React", "JavaScript", "Tailwind CSS"}
    );

    String goal   = "🎯 Build systems that scale to millions";
...
### 🎯 [AssessHub — Internal MCQ Assessment Platform](https://github.com/aayushpawar07/CodePlannet)
> **Spring Boot** • **React** • **MySQL** • **JWT + 2FA** • **Docker** • **AWS EC2**

A full-stack, role-based MCQ testing platform built for organizations to assess trainees and interns.
- ✅ Role-based auth: Admin / Trainee / Intern / PPO with Spring Security + JWT
- ✅ Two-Factor Authentication (Email OTP) for secure login
- ✅ Admin panel: Create tests, view submissions, release results, manage users
- ✅ Deployed on **AWS EC2** with Docker & Nginx reverse proxy
- ✅ 5 seeded teams, real-time test assignment & result tracking
...
Full-stack hotel booking system with room management, booking workflows, and user authentication.
- ✅ Complete CRUD for rooms, bookings, and users
- ✅ Spring Security with role-based access (Admin / Guest)
- ✅ Responsive React frontend with real-time availability
...
Full-stack job portal where students can discover and apply for jobs with role-based signup.
- ✅ Student & Recruiter role-based system
...
End-to-end food delivery platform with real-time order tracking and secure payments.
...
[![Aayush's GitHub Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=aayushpawar07&bg_color=0D1117&color=6C63FF&line=6C63FF&point=FF6B6B&area=true&hide_border=true)](https://github.com/ashutosh00710/github-readme-activity-graph)
...
🌱 Currently learning    → System Design, Kubernetes, Redis
👯 Open to collaborate   → Java Backend | Full-Stack Projects
💬 Ask me about          → Spring Boot, REST APIs, Docker, AWS EC2
📫 Reach me at           → aayushpawar07@gmail.com
...
|:---:|:---:|:---:|
| Java Dev \| Backend Engineer | APIs \| Web Apps \| Backend | Collaborations \| Hackathons |
